...
<body>
    ...
    <table class="table table-sm table-bordered table-striped" style="width:100%">
        <thead>
            ...
            <tr>
                <th class="text-center" colspan="6">En concepto de</th>
            </tr>
            <tr>
        ...
        <tbody>
            @foreach ($receiptInvoices as $receiptInvoice)
                <tr>
                    <td class="text-center">{{ $receiptInvoice->invoice->number }}</td>
                    <td class="text-right">
                        ...
                        <table style="width:100%" class="table table-sm table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($receiptInvoice->taxes as $rit)
                                    <tr>
                                        <td class="text-left">{{ $rit->tax->name }}</td>
                                        <td class="text-right">
    ...
    <table class="table table-sm table-bordered table-striped" style="width:100%">
        <thead>
            <tr>
                <th class="text-center" colspan="3">Medios de Pago</th>
            </tr>
            <tr>
        ...
        <tbody>
            @foreach ($pagos as $pago)
                <tr>
                    <td class="text-center">{{ $pago->method }}</td>
                    <td class="text-right">
                        $&nbsp;{{ number_format($pago->pivot->total, 2, ',', '.') }}
                    </td>
                    <td class="text-right">
