            ...
            <div class="col-3">
                <div class="col-12">
                    <div class="col-12 bg-primary text-center p-5">
                        ...
                        <a href="{{ Route('clients') }}" class="btn btn-sm btn-secondary">Ir a Clientes</a>
                    </div>
                </div>
                <br>
                <div class="col-12">
                    <div class="col-12 bg-info text-center p-5">
                        ...
                        <a href="{{ Route('drivers') }}" class="btn btn-sm btn-warning">Ir a Choferes</a>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="col-12">
                    <div class="col-12 bg-light text-center p-5">
                        ...
                        <a href="{{ Route('invoices') }}" class="btn btn-sm btn-success">Ir a Facturas</a>
                    </div>
                </div>
                <br>
                <div class="col-12">
                    <div class="col-12 bg-dark text-center p-5">
                        ...
                        <a href="{{ Route('receipts') }}" class="btn btn-sm btn-danger">Ir a Recibos</a>
                    </div>
                </div>
            </div>
            <div class="col-6">
