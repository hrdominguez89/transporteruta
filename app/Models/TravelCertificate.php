...
class TravelCertificate extends Model
{
    ...
    // /** Total de estacionamiento (no gravan y no son descontables) */
    public function getTotalEstacionamientoAttribute(): float
    {
    ...
    public function getTotalCalculadoAttribute(): float
    {
        ...
        return round($gravada + $this->total_peajes + $this->total_estacionamiento, 2);
    }
