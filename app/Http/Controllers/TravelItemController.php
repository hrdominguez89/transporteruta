...
class TravelItemController extends Controller
{
    ...
    public function store(Request $request, $travelCertificateId)
    {
        ...
        switch ($type) {
            case 'ADICIONAL':
                // Acepta percent (nuevo) o porcentaje (legacy); guardamos SIEMPRE en `percent`
            ...
            case 'DESCUENTO':
                // Guardamos positivo; el modelo lo descuenta del subtotal gravado
